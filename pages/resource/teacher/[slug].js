...
export default function TeacherArticle({ frontmatter, mdxSource }) {
  return (
    <>
      <SEO
        title={frontmatter.title}
        description={frontmatter.description}
        canonical={`https://1000-island.com/resource/teacher/${frontmatter.slug}`}
      />
...
export async function getStaticPaths() {
  const contentDir = path.join(process.cwd(), 'content/teacher');
